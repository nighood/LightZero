...
if __name__ == "__main__":
    ...
    from zoo.active_search.config.active_search_mz_config import main_config, create_config

    model_path = "/home/nighoodRen/Xia_result/activesearch_muzero_ns25_upc100_rr0_seed0_231115_130313/ckpt/ckpt_best.pth.tar"   # change the path
    ...
    main_config.env.replay_path = 'Xia_result/video/mz_eval'
